...
export function getWriteInstruction<TAccountBufferAccount extends string, TAccountBufferAuthority extends string>(
    input: WriteInput<TAccountBufferAccount, TAccountBufferAuthority>,
): WriteInstruction<typeof LOADER_V3_PROGRAM_ADDRESS, TAccountBufferAccount, TAccountBufferAuthority> {
    // Program address.
    ...
    } as WriteInstruction<typeof LOADER_V3_PROGRAM_ADDRESS, TAccountBufferAccount, TAccountBufferAuthority>;
