...
export async function programMetadata(args: string[], opts?: { suppressOutput?: boolean }): Promise<void> {
    await createProgram({
        exitOverride: true,
...
export function createProgram(internalOptions?: { exitOverride?: boolean; suppressOutput?: boolean }): CustomCommand {
