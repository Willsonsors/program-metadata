...
import { CustomCommand, getClient, getPdaDetailsForWriting, getWriteInput } from '../utils';
...
export async function doCreate(seed: Seed, program: Address, file: string | undefined, _: Options, cmd: CustomCommand) {
